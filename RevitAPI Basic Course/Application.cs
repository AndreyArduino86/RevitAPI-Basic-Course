    ...
    public class Application : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            #region 4. Мой первый плагин 
            {
                ...
                #endregion
                #region 4.2 Кнопка для выбора и копирования видов уровней
                ...
                #endregion
                #region 4.3 Кнопка для отображения существующих видов
                ...
                //panel.AddItem(new PushButtonData(nameof(), "Команда4", assemblyLocation, typeof(LinkSectionBox).FullName)
                //{
